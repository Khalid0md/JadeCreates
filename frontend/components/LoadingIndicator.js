...
export function SmallLoadingIndicator({ colourHex }) {
    return (
        <svg role="status" style={{ color: '#00000011', fill: colourHex && '#' + colourHex }} className="inline mr-2 w-16 h-16 animate-spin fill-green2" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
